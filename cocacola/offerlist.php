...
$numberofoffer=$product->selectall('offer','id',NULL,'status=1','','number');
                        ...
                        <div class="vd_panel-header">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 col-xs-6 controls" style=" margin-left: 80%;">
                                    <!-- start rest -->
                                    <a class="btn vd_btn btn-sm vd_bg-green" href="#" data-toggle="modal" data-target="#addofferModal" style="width: 40%"><i class="fa fa-plus append-icon"></i> Add Offer </a>
                                    <!-- end rest -->
                                ...
                                <div class="col-md-12">
                                    <div class="panel widget">
                                        <div class="panel-heading">
                                            ...
                                            <h3 class="panel-title  vd_black"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Table of Offer List </h3>
                                        ...
                                        <div class="panel-body-list  table-responsive">
                                            <table class="table table-striped table-hover no-head-border">
                                                ...
                                                <tbody>
                                                <?php
                                                $itemid=$product->selectall('offer','*',NULL,'status=1','','data');
                                                for($i=0;$i<$numberofoffer;$i++){

                                                    $itemdata=$product->selectall('item','itemdesc',NULL,'itemcode='.$itemid[$i]['offeritemcode'],'','data');

                                                    ?>


                                                    <tr>
                                                        <td><?php echo $itemid[$i]['id'];?></td>
                                                        <td><?php echo $itemdata[0]['itemdesc'];?></td>
                                                        <td><?php echo $itemid[$i]['qty'];?></td>
                                                        <td><?php echo $itemid[$i]['Bonus'];?></td>
                                                        <td class="center">
...
<div class="modal fade" id="addofferModal" tabindex="-1" role="dialog" aria-labelledby="priceModalLabel" aria-hidden="true" >
    <div class="modal-dialog">
        <form method="POST" action="./operation/addprice.php">
            <div class="modal-content" >
                <div class="modal-header vd_bg-blue vd_white" >
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title" id="priceModalLabel">Add offer for this item</h4>
                </div>
                <div class="modal-body" style="height: 250px;">
                    ...
                    <div class="form-group" >
                        <label class="col-sm-4 control-label" style="margin-top: 20px">QTY</label>
                        <div class="col-sm-7 controls" style="margin-top: 20px">
                            <div class="input-group">
                                <input type="number" placeholder="Enter QTY" name="qty" id="qty">
                            </div>
                        </div>
                    </div>
                    <div class="form-group" >
                        <label class="col-sm-4 control-label" style="margin-top: 20px">Bonus</label>
                        <div class="col-sm-7 controls" style="margin-top: 20px">
                            <div class="input-group">
                                <input type="number" placeholder="Enter Bonus QTY" name="bonus" id="bonus">
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer background-login">
                    ...
                    <button type="submit" onclick="update()" class="btn vd_btn vd_bg-green" id="submit" name="submit" ><i class="fa fa-plus append-icon" ></i> Add Offer </button>
                </div>
        </form> </div>
    <!-- /.modal-content -->
</div>
