...
<script>
    function insertdata() {
        ...
        fileName = "./operation/insertcustomertype.php?type=" + type ;
                    ...
                    <div class="vd_head-section clearfix">
                        <div class="vd_panel-header">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Add Customer Type</li>
                            </ul>
                        ...
                        <div class="vd_panel-header">
                            ...
                            <div class="form-group">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" action="operation/insertcustomertype.php" method="POST" role="form" id="register-form">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="vd_input-wrapper" id="first-name-input-wrapper"> <span class="menu-icon"> <i class="fa icon-location"></i> </span>
                                                    <input type="text" placeholder="Enter Customer Type" class="required" required name="type" id="type">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 text-center mgbt-xs-5" style="margin-left: 74%;">
                                                    <button class="btn vd_bg-green vd_white width-100" type="submit" id="submit" onclick="insertdata()" name="submit">Add Customer Type</button>
                                                </div>
                                            </div>
                                    </form>
                                </div>
