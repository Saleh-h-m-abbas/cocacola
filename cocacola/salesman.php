...
$employee = new emp();
$numberofsalesman=$employee->selectall('salesman','id',NULL,'','','number');
?>
                    ...
                    <div class="vd_head-section clearfix">
                        <div class="vd_panel-header">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">List Salesman</li>
                            </ul>
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel widget">
                                            <div class="panel-heading">
                                                <h3 class="panel-title  vd_black"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Table of Salesman </h3>
                                            </div>
                                            <div class="panel-body-list  table-responsive">
                                                <table class="table table-striped table-hover no-head-border">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $salesmanid=$employee->selectall('salesman','*',NULL,'','','data');
                                                    for($i=0;$i<$numberofsalesman;$i++){
                                                        ...
                                                        $employeesuper=$employee->selectall('supervisors','*',NULL,'id='.$salesmanid[$i]['supervisorid'],'','data');
                                                        $employeesuperid=$employee->selectall('emp','*',NULL,'empno='.$employeesuper[0]['empid'],'','data');
                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $employeesuperid[0]['user'];?></td>
