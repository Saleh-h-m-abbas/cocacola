...
<script>
    function insertdata() {
        ...
        fileName = "./operation/insertordertype.php?ordertype=" + ordertype ;
                        ...
                        <div class="vd_panel-header">
                            ...
                            <div class="form-group">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" action="operation/insertordertype.php" method="POST" role="form" id="register-form">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="label-wrapper">
                                                    <label class="control-label">Order Type <span class="vd_red">*</span></label>
                                                </div>
                                                <div class="vd_input-wrapper" id="first-name-input-wrapper"> <span class="menu-icon"> <i class="fa icon-location"></i> </span>
                                                    <input type="text" placeholder="Enter Order Type" class="required" required name="ordertype" id="ordertype">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 text-center mgbt-xs-5" style="margin-left: 74%;">
                                                    <button class="btn vd_bg-green vd_white width-100" type="submit" id="submit" onclick="insertdata()" name="submit">Add Order Type</button>
                                                </div>
                                            </div>
                                    </form>
                                </div>
