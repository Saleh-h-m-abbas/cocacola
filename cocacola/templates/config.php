...
/*  GENERAL SETTING  */
	...
	$author = 'CocaCola'; // for author meta data: <meta name="author" content="$author; ">
	$website_name = 'CocaCola'; // for closing title every page: <title>$title;  | $website_name;</title>
	$footer_message = 'Copyright &copy;2018 CocaCola Inc. All Rights Reserved'; // Set Copyright message on footer
