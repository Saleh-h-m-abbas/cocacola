    ...
    <li id="top-menu-profile" class="profile mega-li"> 
        <a href="#" class="mega-link"  data-action="click-trigger"> 
            ...
            <span class="mega-name">
                Caroline <span class="child-menu-icon"><i class="fa fa-caret-down"></i></span> 
            </span>
        </a> 
...
"></i></div> <div class="menu-text">Privacy</div> </a> </li>
                    ...
                    <li> <a href="pages-lockscreen.php"> <div class="menu-icon"><i class="  fa fa-key"></i></div> <div class="menu-text">Lock</div> </a> </li>
                    <li> <a href="pages-logout.php"> <div class="menu-icon"><i class=" fa fa-sign-out"></i></div>  <div class="menu-text">Sign Out</div> </a> </li>
                    <li class="line"></li>
