...
$numberofconfirmorder= $product->selectall('quotations','*',NULL,'status=1','','number');
$numberofcancelorder= $product->selectall('quotations','*',NULL,'status=2','','number');
$numberofneworder= $product->selectall('quotations','*',NULL,'status=0','','number');
...
$(window).load(function() 
	...
	Morris.Donut({
	  ...
	  data: [
		{label: "Confirm Order", value: <?php echo $numberofconfirmorder;?>},
		{label: "Cancel order", value: <?php echo $numberofcancelorder;?>},
		{label: "new Order", value: <?php echo $numberofneworder;?>}
	  ],
	  colors: ["#339933","#e60000", "#e6b800"]
	});
